...
public class Main {
    ...
    /*public static void countDeadlinesUsingStreams(ArrayList<Task> tasksData){
    ...
    //using streams to check deadline and printing it
    public static void printDeadlinesUsingStreams(ArrayList<Task> tasksData){
        System.out.println("Printing data using streams");
        tasksData.stream()
                .filter((t) -> t instanceof Deadline) //filtering deadline
                .forEach(System.out::println);
